      ...
      <div className="p-3">
        <div className="relative w-full" style={{ aspectRatio: '100/92' }}>
          <svg viewBox="0 0 100 92" className="w-full h-full">
            <defs><filter id="kg-glow2" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur in="SourceGraphic" stdDeviation="0.5" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
            {connections.map(([a, b]) => {
